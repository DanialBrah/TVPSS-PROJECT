...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
        <li><a href="/TVPSS/equipment">School</a></li>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <form action="../edit/${teacher.staffId}" method="post" class="container">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="staffId" name="staffId" value="${teacher.staffId}" required readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="teachingExperience" name="teachingExperience" value="${teacher.teachingExperience}" min="0">
                </div>
                <div class="mb-3">
