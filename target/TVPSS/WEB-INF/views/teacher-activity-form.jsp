...
<div class="main-content">
    ...
    <div class="form-container">
        <form action="/TVPSS/activities/add2" method="post" enctype="multipart/form-data" id="activityForm" class="container">
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="imageFile" class="form-label">Upload Proof (Image)</label>
        <input type="file" class="form-control" id="imageFile" name="imageFile" accept="image/*" required>
    </div>
    <button type="submit" class="btn btn-primary">Save Activity</button>
    <a href="${pageContext.request.contextPath}/teachers/activity" class="btn btn-secondary">Cancel</a>
</form>
