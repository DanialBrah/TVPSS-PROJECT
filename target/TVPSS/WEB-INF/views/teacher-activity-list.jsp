	...
	<div class="main-content">
		...
		<div class="table-container">
			...
			<form action="/TVPSS/activities/filter" method="get" class="mb-3">
				<div class="row g-3">
					<div class="col-md-4">
						<label for="school" class="form-label">Filter by School</label> <select
							class="form-select" id="school" name="school.id">
					...
					<div class="col-md-4">
						<label for="date" class="form-label">Filter by Date</label> <input
				...
				<tbody>
					<c:forEach items="${activities}" var="activity">
						<tr>
							...
							<td>${activity.date}</td>
							<td><c:if test="${not empty activity.imageProof}">
									<img
										src="${pageContext.request.contextPath}/${activity.imageProof}"
										alt="Activity Image"
										style="max-width: 100px; max-height: 100px;">
								</c:if> <c:if test="${empty activity.imageProof}">
									<span>No Image</span>
								</c:if></td>
							<td><a
