...
<body>
	...
	<div class="sidebar">
		...
		<ul>
			<li><a href="/TVPSS/teachers/version">Version</a></li>
			<li><a href="/TVPSS/teachers/equipment">Equipment</a></li>
			...
			<li><a href="/TVPSS/teachers/channel">Channel</a></li>
	...
	<div class="main-content">
		...
		<div class="form-container">
			<form action="../edit2/${teacher.staffId}" method="post"
				class="container">
				<div class="mb-3">
				...
				<div class="mb-3">
					<label for="staffId" class="form-label">Staff ID</label> <input
						type="text" class="form-control" id="staffId" name="staffId"
						value="${teacher.staffId}" required readonly>
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					<label for="teachingExperience" class="form-label">Teaching
						Experience</label> <input type="number" class="form-control"
						id="teachingExperience" name="teachingExperience"
						value="${teacher.teachingExperience}" min="0">
				</div>
				<div class="mb-3">
					<label for="school" class="form-label">School</label> <input
						type="text" class="form-control" id="school" name="schoolName"
						value="${teacher.school != null ? teacher.school.name : ''}"
						placeholder="No school assigned" readonly>
				</div>
