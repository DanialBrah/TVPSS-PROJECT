...
<body>
    ...
    <div class="main-content">
        <h2 class="text-center mb-4">Edit Crew</h2>
        <div class="form-container">
            <form action="../edit/${crew.crewId}" method="post" class="container">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="crewId" name="crewId" value="${crew.crewId}" required readonly>
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" class="form-control" id="email" name="email" value="${crew.email}" required>
                </div>
                <div class="mb-3">
                    ...
                    <select class="form-control" id="school" name="school.id" required>
                        ...
                        <c:forEach var="school" items="${schools}">
                            <option value="${school.id}" 
                                <c:if test="${crew.school != null && crew.school.id == school.id}">selected</c:if>>
                                ${school.name}
                            </option>
                        </c:forEach>
                    </select>
