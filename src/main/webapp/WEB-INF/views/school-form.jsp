...
<div class="sidebar">
    ...
    <div class="container">
        ...
        <form action="<c:choose>
                        <c:when test='${school.id != null}'>
                            ${pageContext.request.contextPath}/schools/edit/${school.id}
                        </c:when>
                        <c:otherwise>
                            ${pageContext.request.contextPath}/schools/add
                        </c:otherwise>
                     </c:choose>" 
              method="post">
            <div class="form-group">
                <label for="name">School Name</label>
                <input type="text" id="name" name="name" value="${school.name}" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="address">Address</label>
                <textarea id="address" name="address" class="form-control" required>${school.address}</textarea>
            </div>
            <div class="form-group">
                <label for="contact">Contact</label>
                <input type="text" id="contact" name="contact" value="${school.contact}" class="form-control">
            </div>
            <div class="form-group">
                <label for="version">Version</label>
                <input type="text" id="version" name="version" value="${school.version}" class="form-control">
            </div>
