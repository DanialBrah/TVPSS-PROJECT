...
<body>
	...
	<h1>Teacher List</h1>
	<a href="/TVPSS/teachers/add" class="btn btn-primary mb-3">Add New Teacher</a>
				...
				<tbody>
					<c:forEach var="teacher" items="${teachers}">
						<tr>
							...
							<td>${teacher.teachingExperience} years</td>
							<td>${teacher.school.name}</td>
							<td>
								<a href="${pageContext.request.contextPath}/teachers/edit/${teacher.staffId}" class="btn btn-sm btn-warning">Edit</a>
								<a href="${pageContext.request.contextPath}/teachers/delete/${teacher.staffId}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this teacher?')">Delete</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
