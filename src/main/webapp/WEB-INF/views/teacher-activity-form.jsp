...
<body>
	...
	<div class="main-content">
		...
		<div class="form-container">
			<form action="/TVPSS/activities/add2" method="post"
				enctype="multipart/form-data" id="activityForm" class="container">
				<div class="mb-3">
				...
				<a href="${pageContext.request.contextPath}/teachers/activity"
