...
<body>
    ...
    <div class="main-content">
        <h2 id="formTitle">Add New Crew</h2>

        <div class="form-container">
            <form action="add" method="post" id="crewForm" class="container">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary">Save Crew</button>
                <a href="${pageContext.request.contextPath}/crew" class="btn btn-secondary">Cancel</a>
            </form>
        </div>
    </div>
</body>
